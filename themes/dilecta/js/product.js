...

		{
			...
			$('#small_pic').fadeOut('fast', function(){
				...
				if (typeof(jqZoomEnabled) != 'undefined' && jqZoomEnabled){
                                        ...
                                        $('#image-block #view_full_size').append('<a id="big_pic" class="jqzoom" href="'+domAAroundImgThumb.attr('href')+'" title="'+domAAroundImgThumb.attr('title')+'"><img id="small_pic" src="'+newSrc+'" /></a>').fadeIn('fast');
...

{
	...
	$('.product-no-jqzoom, .product-info .left .zoom-image a').click(function(){

...
{if (int)(Configuration::get('PS_PRODUCTS_PER_PAGE')) != 8}
		{assign var='nArray' value=array((int)(Configuration::get('PS_PRODUCTS_PER_PAGE')), 16, 32, 64)}
{else}
		{assign var='nArray' value=array(8, 16, 32, 64)}
{/if}

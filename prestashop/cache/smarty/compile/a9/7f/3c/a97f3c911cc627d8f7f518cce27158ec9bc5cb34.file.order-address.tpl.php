<?php /* Smarty version Smarty-3.1.13, created on 2014-05-23 14:11:28
         compiled from "/home/admedon/public_html/prestashop/themes/theme526/order-address.tpl" */ ?>
<?php /*%%SmartyHeaderCode:165380104537f8f50aecca4-87981363%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_valid = $_smarty_tpl->decodeProperties(array (
  'file_dependency' => 
  array (
    'a97f3c911cc627d8f7f518cce27158ec9bc5cb34' => 
    array (
      0 => '/home/admedon/public_html/prestashop/themes/theme526/order-address.tpl',
      1 => 1393474386,
      2 => 'file',
    ),
  ),
  'nocache_hash' => '165380104537f8f50aecca4-87981363',
  'function' => 
  array (
  ),
  'variables' => 
  ...
  'unifunc' => 'content_537f8f50d495d4_30573418',
),false); /*/%%SmartyHeaderCode%%*/?>
<?php if ($_valid && !is_callable('content_537f8f50d495d4_30573418')) {function content_537f8f50d495d4_30573418($_smarty_tpl) {?><?php if (!is_callable('smarty_function_counter')) include '/home/admedon/public_html/prestashop/tools/smarty/plugins/function.counter.php';
...
<?php $_tmp4=ob_get_clean();?><?php if (!$_smarty_tpl->tpl_vars['multi_shipping']->value&&$_tmp4&&!$_smarty_tpl->tpl_vars['cart']->value->isVirtualCart()){?>
		<div class="button_multishipping_mode" id="multishipping_mode_box">
			<h3><?php echo smartyTranslate(array('s'=>'Multi-shipping'),$_smarty_tpl);?>
</h3>
...
" class="button_large"><?php echo smartyTranslate(array('s'=>'Add a new address'),$_smarty_tpl);?>
		...
		<div class="clear"></div>
			<ul class="bordercolor address item" id="address_delivery" <?php if ($_smarty_tpl->tpl_vars['cart']->value->isVirtualCart()){?>style="display:none;"<?php }?>>
			</ul>
			<ul class="bordercolor address alternate_item <?php if ($_smarty_tpl->tpl_vars['cart']->value->isVirtualCart()){?>full_width<?php }?>" id="address_invoice">
			</ul>
	<br class="clear" />

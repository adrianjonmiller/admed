...
{/foreach}
		...
		<p id="cart-prices">
			...
			{if !$logged}
			<span  class="price ajax_cart_shipping_cost" style="float:left!important">{$shipping_cost}1</span>
			{else}
			<span id="cart_block_shipping_cost" class="price ajax_cart_shipping_cost">{$shipping_cost}1111</span>

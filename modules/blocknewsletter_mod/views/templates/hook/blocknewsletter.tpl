...
<div id="newsletter_block_left_mod" class="block">
		...
		<form action="{$link->getPageLink('index')}" method="post">
			<p>
				...
				<input type="text" name="email" size="18" 
					...
					onfocus="javascript:if(this.value=='{l s='your e-mail' mod='blocknewsletter_mod'}')this.value='';" 
					onblur="javascript:if(this.value=='')this.value='{l s='your e-mail' mod='blocknewsletter_mod'}';" 
					class="inputNew" />
				<!--<select name="action">

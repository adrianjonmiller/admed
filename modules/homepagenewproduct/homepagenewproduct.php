...
class Homepagenewproduct extends Module
{
	private $_html = '';
	...
	function install()
	{
		if (!Configuration::updateValue('HOME_new_NBR', 8) || !parent::install() || !$this->registerHook('displayHome') || !$this->registerHook('displayHeader'))
			return false;
		return true;
	}
		...
		<form action="'.Tools::safeOutput($_SERVER['REQUEST_URI']).'" method="post">
			<fieldset><legend><img src="'.$this->_path.'logo.gif" alt="" title="" />'.$this->l('Settings').'</legend>
				...
				<div class="margin-form">
					<input type="text" size="5" name="nbr" value="'.Tools::safeOutput(Tools::getValue('nbr', (int)(Configuration::get('HOME_new_NBR')))).'" />
	...
	public function hookDisplayHome($params)
	{
		...
		$products = Product::getNewProducts((int)($params['cookie']->id_lang), 0, (int)(Configuration::get('HOME_new_NBR')));
		...
		return $this->display(__FILE__, 'homepagenewproduct.tpl');
	}
}